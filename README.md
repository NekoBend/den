...
CLI, and `shell/README.md` for the shell environment. `COMMANDS.md` is a one-page
reference of every command den adds, with per-shell (bash/zsh, pwsh, cmd) availability.
